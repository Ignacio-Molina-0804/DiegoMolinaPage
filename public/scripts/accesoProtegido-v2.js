...
document.addEventListener("DOMContentLoaded", () => {
  ...
  overlay.innerHTML = `
    <div style="
      ...
      width: 90%;
    ">
      <h2 style="color: #00ff7f; margin-bottom: 1rem; font-size: 1.3rem;">Acceso restringido</h2>
      <p style="margin-bottom: 1.3rem; font-size: 1rem; color: #ddd;">Ingresá la clave para continuar</p>
      ...
      <p id="errorMsg" style="color: #ff6666; margin-top: 0.8rem; display: none; font-size: 0.9rem;">Clave incorrecta</p>
